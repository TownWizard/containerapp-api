...
--
--
DROP TABLE IF EXISTS `#__townwizard_partner`;
...
DROP TABLE IF EXISTS `#__townwizard_partner_category`;
...
DROP TABLE IF EXISTS `#__townwizard_partner_location`;
...
DROP TABLE IF EXISTS `#__townwizard_section`;
CREATE TABLE IF NOT EXISTS `#__townwizard_section` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(120) NOT NULL,
  `default_image` varchar(120) DEFAULT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `default_url` varchar(120) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;


DROP TABLE IF EXISTS `#__townwizard_partner_section`;
...
INSERT INTO `#__townwizard_partner` (`id`, `name`, `creator_id`, `itunes_app_id`, `partner_category_id`, `phone_number`, `website_url`, `image`, `published`, `priority`, `ordering`, `featured_partner`, `facebook_app_id`) VALUES
...
INSERT INTO `#__townwizard_partner_category` (`id`, `title`) VALUES
(1, 'Towns'),
(2, 'Resorts');


INSERT INTO `#__townwizard_partner_location` (`id`, `partner_id`, `street`, `city`, `state`, `country`, `zip`, `latitude`, `longitude`, `map_zoom`) VALUES
...
INSERT INTO `#__townwizard_partner_section` (`id`, `name`, `image`, `partner_id`, `section_id`, `parent_id`, `url`, `ordering`) VALUES
...
INSERT INTO `#__townwizard_section` (`id`, `name`, `default_image`, `default_url`, `is_default`) VALUES
