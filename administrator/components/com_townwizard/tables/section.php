...
class TableSection extends TownwizardTable
{
    ...
    public $default_android_url = null;

    public $default_android_json_api_url = null;
    ...
    protected $_validationRules = array(
        ...
        array('maxlength', 'default_url, default_json_api_url, default_android_url, default_android_json_api_url', array('maxlength' => 255)),
